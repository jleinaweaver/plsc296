...
- Visualizating the relationship between two variables
...
:::: {.columns}
::: {.column width="50%"}
```{r, echo=FALSE, fig.retina=3, fig.align='center', fig.width=5, fig.asp=.9, cache=TRUE}
ggplot(mpg, aes(x = class, fill = drv)) +
  geom_bar(position = position_dodge(preserve = "single")) +
...
:::: {.columns}
::: {.column width="50%"}
```{r, echo=FALSE, fig.retina=3, fig.width=5, fig.asp=.85, fig.align='center', cache=TRUE}
