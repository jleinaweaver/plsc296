...
## Adjusting for Unemployment {background-image="Images/background-slate_v2.png" .center}
...
## Remove the Missing Data {background-image="Images/background-slate_v2.png" .center}
...
## Adjusting for Education {background-image="Images/background-slate_v2.png" .center}
...
## Causal Arguments {background-image="Images/background-slate_v2.png" .center}
...
## Adjusting for Confounders {background-image="Images/background-slate_v2.png" .center}
:::: {.columns}
::: {.column width="50%"}
```{r, fig.align='center', fig.asp=1, fig.width=7, eval=FALSE}
d |>
...
::: {.column width="50%"}
```{r, fig.align='center', fig.asp=1, fig.width=6, eval=FALSE}
d |>
  filter(Year == 2016) |>
...
## Check for Variation {background-image="Images/background-slate_v2.png" .center}

```{r, fig.align='center', fig.asp=.75, fig.width=8, eval=FALSE}
d |>
  mutate(
...
```{r, fig.retina = 3, fig.align = 'center', out.width='80%', fig.height=4, fig.width=9, eval=FALSE}
## Manual DAG
d1 <- tibble(
  x = c(1, 2, 3),
  y = c(1, 2, 1),
...
## Possible Confounder: Immunizations {background-image="Images/background-slate_v2.png" .center}

<br>

```{r, fig.align='center', fig.asp=.4, fig.width=13, eval=FALSE}
d |>
  filter(Year == 2016) |>
  mutate(
    # immune2 = case_when(
...
## Possible Confounder: GDP {background-image="Images/background-slate_v2.png" .center}
...
## Possible Confounder: Infant Mortality {background-image="Images/background-slate_v2.png" .center}
...
## Possible Confounder: Education {background-image="Images/background-slate_v2.png" .center}
