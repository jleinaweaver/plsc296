...
- Keep working in: Univariate_Visualizations.R
...
**SLIDE**: So, you can now make a much cleaner visualization, how do import it into reports or presentation slides?
...
![](Images/05_2-saving_viz1.png){.absolute width="700" left=200}

### Step 2

![](Images/05_2-saving_viz2.png){.absolute width="600" left=200}

### Step 3

![](Images/05_2-saving_viz3a.png){.absolute width="550" left=0}

![](Images/05_2-saving_viz3b.png){.absolute width="400" right=0}

:::

::: notes

*How to export an image using RStudio*

- Emphasize they should resize the image for the space they
...
- Read Chapter 3 in Pollock & Edwards

- Submit Exercises 2, 4 and 5 to Canvas

- Keep practicing with our code from this week!
