...
- A longer datasheet but it let's us examine trends across time

<br>

The cool part is working with either dataset is equally simple regardless of dataset length!
...
```{r, fig.retina=3, fig.align='center', fig.asp=0.4, out.width='100%', fig.width=8, eval=FALSE}
library(gganimate)
library(gapminder)
