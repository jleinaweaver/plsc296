...
![](Images/05_2-Input_WDI_Data2.png){style="display: block; margin: 0 auto"}
...
1. Name the object you want to represent the dataset

2. MAKE SURE TO INCLUDE THE "NA" in the NA field BEFORE you import the data!
...
**SLIDE**: Saving your visualizations in RStudio
...
**Saving Visualizations in RStudio**

::: {.panel-tabset}

### Step 1

![](Images/05_2-saving_viz1.png){style="display: block; margin: 0 auto"}

### Step 2

![](Images/05_2-saving_viz2.png){style="display: block; margin: 0 auto"}

### Step 3

![](Images/05_2-saving_viz3.png){style="display: block; margin: 0 auto"}
...
The attached dataset includes FIVE measures taken from the World Bank's WDI database. SP2026-Wk05-WDI_Data.xlsx
