...
Once you have z-scores you can describe each observation or sample statistic in terms of its relation to the mean

- Is it above or below?

- How far away is it in standardized terms?

- What proportion of the data is as close as that observation to the mean?
...
**Ok, so what does it mean to say that the SE is .2?**

- **Explain it to me using the intuitions we've been discussing**

- (If you ran this experiment hundreds of times, the sample averages would miss the TRUE population parameter by an average of .2 inches)

- (95% of those separate experiments would probably give you estimates between 5.6 and 6.4 inches)
...
- (If you ran this experiment hundreds of times, the sample averages would miss the TRUE population parameter by an average of .8 mph)

- (95% of those separate experiments would probably give you estimates between 45.4 and 48.6 mph)
...
Let's open up the ANES codebook on Canvas (or the data itself)

- Everybody pick a single outcome variable from the ANES dataset we'd like to better understand. 

- Pick something new, no overlap. 

- Propose a research hypothesis and a null hypothesis for your outcome

- Focus on describing a SINGLE variable ALONE, not yet testing cause and effect

    - e.g. More than half of American voters support raising age limits for social security
