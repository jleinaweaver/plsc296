...
## Data Analysis in Political Science {background-image="Images/background-data_blue_v3.png" .center}
...
::: {.r-fit-text}
Setting up our Semester (Spring 2025)
:::
...
## Introductions {background-image="Images/background-slate_v2.png" .center}
...
::: {.r-fit-text}
**Review the syllabus and Canvas Modules!**
:::
...
## What do we learn about "height" from our warm-up exercises? {background-image="Images/background-teal4.png" .center}
...
## What do we learn about "measurement" from our warm-up exercises? {background-image="Images/background-teal4.png" .center}
...
## Science as Measurement {background-image="Images/background-teal4.png" .center}
...
## Assignment for Next Class {background-image="Images/background-teal4.png" .center}
