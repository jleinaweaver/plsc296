...
## Randomized Controlled Trials (RCTs) {background-image="Images/background-slate_v2.png" .center}
...
## Identification and the DGP {background-image="Images/background-slate_v2.png" .center}
...
## The Data Generating Process (DGP) {background-image="Images/background-slate_v2.png" .center}
...
## Directed Acyclic Graphs (DAGs) {background-image="Images/background-slate_v2.png" .center}
...
## Do ice cream sales create arsonists? {background-image="Images/background-slate_v2.png" .center}
...
## Do Not Control for Mediators {background-image="Images/background-slate_v2.png" .center}
...
## Do Not Control for Colliders {background-image="Images/background-slate_v2.png" .center}
...
## Classify our Options {background-image="Images/background-slate_v2.png" .center}
...
## For Today {.center background-image="Images/background-slate_v2.png"}
