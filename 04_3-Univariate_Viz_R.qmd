...
## Univariate_Visualizations.R {background-image="Images/background-slate_v2.png" .center}
...
```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/04_3-export_image1.png")
```
...
```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/04_3-export_image2.png")
```
...
::: {.column width="50%"}
```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/04_3-R_Graphics_Cookbook.jpg")
```
:::
::::
