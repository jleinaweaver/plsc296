...
## Reserach question TBD {background-image="Images/background-data_blue_v4.png" .center}
...
```{r, echo=TRUE}
aggregate(data = mpg, cty ~ drv, FUN = median)
```
...
**SLIDE**: You can directly use summary this way too
