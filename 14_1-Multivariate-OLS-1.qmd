...
## Our Baseline Estimate {background-image="Images/background-slate_v2.png" .center}
...
**4. Fit a multiple regression using the dummy confounder**
```{r, echo=TRUE}
...
```{r}
modelsummary(models = list("Model 2" = res2), out = "gt", fmt = 2, stars = c("*" = .05), gof_omit = "IC|F|Log", coef_map = c("fertility_rate_per_woman" = "Fertility (births per woman)", "wealthier_median" = "Wealth > Median", "(Intercept)" = "Constant")) |>
  gt::tab_style(style = list(
                  gt::cell_fill(color = 'white'),
                  gt::cell_text(size = "x-large")
  ), locations = gt::cells_body())
