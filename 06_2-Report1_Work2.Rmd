...
.size50[
1. Analyze the `Total` index score **AND** your assigned indicator across time (provide snapshots in 2006 and 2014; 4 viz total)

2. Analyze the trajectory of a single country across time with line plots for both the Total index score **AND** your assigned indicator 
]
