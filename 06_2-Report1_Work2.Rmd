...
.size50[
1. Analyze the `Total` index score **AND** your selected indicator from Section 3 across time (provide snapshots in 2006 and 2014)

2. Analyze the trajectory of a single country across time with line plots
]
