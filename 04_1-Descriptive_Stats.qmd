...
# Access any variable in the dataset using '$'
mpg$manufacturer
```
...
## What count and proportion of cars in `mpg` are four-wheel drive (`drv`)? {background-image="Images/background-slate_v2.png" .center}
