...
## Correlation Does Not Imply Causation {.center background-image="libs/Images/background-slate_v2.png"}

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/12_1-dinosaur_correlation.webp")
```
...
## Correlation May Imply Causation {.center background-image="libs/Images/background-slate_v2.png"}
...
## Correlation and Causation {.center background-image="libs/Images/background-slate_v2.png"}
...
## Exploratory Data Analyses {.center background-image="libs/Images/background-slate_v2.png"}
...
## 1. Analyzed the Methodology {.center background-image="libs/Images/background-slate_v2.png"}
...
## 2. Univariate Analyses {.center background-image="libs/Images/background-slate_v2.png"}
...
## 3. Bivariate Analyses {.center background-image="libs/Images/background-slate_v2.png"}
...
## Building a Causal Argument {.center background-image="libs/Images/background-slate_v2.png"}
...
## Building a Causal Argument {background-image="libs/Images/background-slate_v2.png"}

![](libs/Images/13_1-Student.png){.absolute bottom="100" left="0" width="45%"}

![](libs/Images/13_1-small_class.webp){.absolute bottom="130" right="0" width="50%"}
...
![](libs/Images/13_1-delorean-time-travel.gif){.absolute top="0" left="250" width="60%"}

![](libs/Images/13_1-Student.png){.absolute bottom="0" left="0" width="35%"}

![](libs/Images/13_1-large_class_size.png){.absolute bottom="0" right="0" width="45%"}
...
![](libs/Images/13_1-Student.png){.absolute top="0" left="340" width="35%"}

![](libs/Images/13_1-small_class.webp){.absolute bottom="0" left="0" width="45%"}
...
![](libs/Images/12_1-students2.jpg){.absolute top="0" left="25" width="40%"}

![](libs/Images/13_1-delorean-time-travel.gif){.absolute top="50" right="0" width="45%"}
...
##  {.center background-image="libs/Images/background-slate_v2.png"}
...
## Randomized Controlled Trials (RCTs) {.center background-image="libs/Images/background-slate_v2.png"}
...
##  {.center background-image="libs/Images/13_1-armed-forces-personnel.svg"}
...
## Our Challenge {background-image="libs/Images/background-slate_v2.png"}

**Estimating Causal Effects Using Observational Data**

![](libs/Images/13_1-SPS_Map.png){.absolute left=75 width="40%"}

![](libs/Images/13_1-small_class.webp){.absolute top=150 right=75 width="33%"}

![](libs/Images/13_1-large_class_size.png){.absolute bottom=20 right=75 width="33%"}
...
## The Challenge of Observational Data {.center background-image="libs/Images/background-slate_v2.png"}
...
## Developing a Causal Argument {background-image="libs/Images/background-slate_v2.png"}

![](libs/Images/13_1-HK_ch5.png){.absolute left=50 width="40%"}

![](libs/Images/13_1-HK_ch5_TOC.png){.absolute top=230 right=10 width="45%"}
...
## The Data Generating Process (DGP) {.center background-image="libs/Images/background-slate_v2.png"}

<br>

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/12_1-Using_our_Senses.jpg")
```
...
## Identification {background-image="libs/Images/13_1-cartoon-dog.jpg"}
...
## Identification and the DGP {.center background-image="libs/Images/background-slate_v2.png"}
...
## For Next Class {.center background-image="libs/Images/background-slate_v2.png"}
