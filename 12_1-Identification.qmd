...
## Correlation Does Not Imply Causation {background-image="libs/Images/background-slate_v2.png" .center}
...
## Exploratory Data Analyses {background-image="libs/Images/background-slate_v2.png" .center .smaller}

```{r}
d <- read_excel("../Data_in_Class-SP24/Merged_Dataset-2006-2016.xlsx", na = "NA")

d |>
  select(Country, Year, FSI_Total, P3_Human_Rts) |>
  slice_sample(n = 10) |>
...
## 1. Analyzed the Methodology {background-image="libs/Images/background-slate_v2.png" .center}
...
## 2. Univariate Analyses {background-image="libs/Images/background-slate_v2.png" .center}
...
## 3. Bivariate Analyses {background-image="libs/Images/background-slate_v2.png" .center}
...
## The Fundamental Problem of Causal Inference {background-image="libs/Images/background-slate_v2.png" .center}
...
## {background-image="libs/Images/13_1-armed-forces-personnel.svg" .center}
...
## The Challenge of Observational Data {background-image="libs/Images/background-slate_v2.png" .center}
...
## Describing the Data Generating Process (DGP) {background-image="libs/Images/background-slate_v2.png" .center}
