...
.size70[**What is a research question?**]
...
background-image: url('libs/Images/02_2-soldier-British-trench-Western-Front-World-War.webp')
background-size: 100%
background-class: center
class: middle
...
.size55[
**Propose a research question using the data you selected before class**
