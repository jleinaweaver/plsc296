...
## The Key Principles of Data Analysis {background-image="Images/background-data_blue_v3.png" .center}
...
## 1. Data analysis is not a linear process {background-image="Images/background-data_blue_v3.png" .center}
...
## 3. Variable type determines the tool {background-image="Images/background-data_blue_v3.png" .center}
...
## 4. Evaluate Validity & Reliability {background-image="Images/background-data_blue_v3.png" .center}
...
## Excel Auto-Formatting is Bad {background-image="Images/background-data_blue_v3.png" .center}
...
## Excel Allows Accidental Edits {background-image="Images/background-data_blue_v3.png" .center}
...
## Report 1: Section 2 {background-image="Images/background-data_blue_v3.png" .center}
...
## For Today {background-image="Images/background-data_blue_v3.png" .center}

<br>

### What did you find in your pre-class explorations?
