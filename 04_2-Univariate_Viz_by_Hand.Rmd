...
### Ok, how did you complete this?

### - What function(s) did you run?
...
Next question asked you to do a couple things.

### First, how different are the mean and median populations?
...
# The Difference
mean(midwest$poptotal) - median(midwest$poptotal)
```
]

???

### Ok, how do we explain this substantial difference?
...
max(midwest$poptotal) - min(midwest$poptotal)
sd(midwest$poptotal)
```
]
...
.code110[
```{r, echo=TRUE, eval=TRUE}
# Identify the range, View() the data and sort by sleep
...
**SLIDE**: Let me show you a new function that will prove very useful for questions like this.
...
Filter() is a very useful function!

- Note the double equals sign here from our notes back in week 3.

- One equals sign is to save a value

- Two is to compare two values
...
.size50[**By hand**, draw a bar plot of **the proportion** of parties that have controlled the presidency since 1953 in the presidential data set.
]

.size35[Process: 1) Count the levels, 2) Draw X axis with labels, 3) Draw Y axis to max height, 4) Add the bars]
...
.center[.size35[.content-box-blue[**Numerical Variable: Histograms and Box Plots**]]]

<br>

```{r, echo = FALSE, fig.align = 'center', out.width = '62%'}
knitr::include_graphics("libs/Images/04_2-Fuel_Economy.gif")
```
...
#   labs(x = "Fuel Economy (City)", y = "")
# 
# ggsave("libs/Images/04_2-Histogram_mpg.png")
...
# 
# ggsave("libs/Images/04_2-Overlaid_Histogram_mpg.png")
...
#   annotate("segment", x = quantile(mpg$cty, probs = .25), xend = quantile(mpg$cty, probs = .75), y = c(15, 25), yend = c(15, 25))
# 
# ggsave("libs/Images/04_2-Boxplot_mpg.png")

###########################
## Create gif
# library(gifski)
# 
# png_files1 <- c("libs/Images/04_2-Histogram_mpg.png",
#                 "libs/Images/04_2-Overlaid_Histogram_mpg.png")
# 
#gifski(png_files1, gif_file = "libs/Images/04_2-Fuel_Economy.gif", delay = 2)
```
...
.center[.size35[Make a line plot of the US population since 1790 (data set: uspop)]]
