...
.center[.size60[**What proportion of US presidents since 1953 have been Republicans?**]]
...
.center[.size60[**Why are the mean and median total populations in the midwest so different from each other?**]]
...
.center[.size55[**Which mammal sleeps the least and which the most?**]]
...
.center[.size40[Draw a line plot of US unemployment (`unemploy`) for the most recent 12 months in the `economics` data set.]]
