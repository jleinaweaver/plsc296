...
**Does a free press ensure better environmental quality around the world?**
...
**OPTION 1: Overall Analysis - Strengths vs Weaknesses**

- *Split class into small groups (3?)*

- GROUPS, you have TEN minutes to build a list of STRENGTHS ONLY

- *ON BOARD*: Report back - build list

- GROUPS, now you know the baseline stuff, back to the strengths! Five more minutes to deepen this list! I want a STRONG argument that represents the best of this project!

- *ON BOARD*: Report back - build list

- GROUPS, you have now TEN minutes to build a list of WEAKNESSES

- *ON BOARD*: Report back - build list

<br>

**How are we doing? Everybody have a ton of good notes?**
