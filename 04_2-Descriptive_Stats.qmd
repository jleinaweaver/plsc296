...
- The specific datasets and variables I want you to use are in the Canvas assignment details

<br>

For each question you MUST: 

1) Submit the code you used, 

2) Explain your answer to the question, and 

3) Make an argument that this is a good answer to the question

<br>

Important note: You must run `library(tidyverse)` in your R file to access these datasets.
