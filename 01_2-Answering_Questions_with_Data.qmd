...
## Questions on the Syllabus? {background-image="Images/background-data_blue_v3.png" .center}

<br>

```{r, fig.align='center'}
tibble(
  x1 = c("Attendance & Participation", "Assignments", "- Report: Analyze the Outcome Variable(s)", "- Report: Analyze the Predictor Variable(s)", "- Report: Test of your Hypotheses"),
  x2 = c("50%", "50%", "", "", "")
) |>
...
## Questions on the Syllabus? {background-image="Images/01_2-Backup-Your-Computer.jpg"}
...
## Assignment for Today {background-image="Images/background-slate_v2.png" .center}
...
## Population of the USA in 2020 {background-image="Images/background-slate_v2.png" .center}
...
## Number of countries in the world? {background-image="Images/background-slate_v2.png" .center}

```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/01_2-World-map-countries.jpg")
```
...
## {background-image="Images/01_2-UN_Map_Wikipedia.png" .center background-size='95%'}
...
## Number of current wars? {background-image="Images/background-slate_v2.png" .center}

<br>

```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/01_2-ukraine_fighting.webp")
```
...
## {background-image="Images/01_2-2023_Ongoing_conflicts_around_the_world.png" background-size='90%'}
...
## This semester you will develop skills: {background-image="Images/background-slate_v2.png" .center}
...
1. Brians et al (2011) chapter 5 on measurement
