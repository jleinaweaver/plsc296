...
## Questions on the Syllabus? {background-image="libs/Images/background-data_blue_v3.png" .center}

<br>

```{r, fig.align='center'}
tibble(
  x1 = c("Attendance & Participation", "Assignments", "- Report: Analyze the Outcome Variable(s)", "- Report: Analyze the Predictor Variable(s)", "- Report: Bivariate Test of your Hypotheses", "- Report: Multivariate Test of your Hypotheses"),
  x2 = c("50%", "50%", "", "", "", "")
) |>
...
## Questions on the Syllabus? {background-image="libs/Images/01_2-Backup-Your-Computer.jpg"}
...
## Assignment for Today {background-image="libs/Images/background-slate_v2.png" .center}
...
## Population of the USA in 2020 {background-image="libs/Images/background-slate_v2.png" .center}
...
## {background-image="libs/Images/01_2-census_mailer.jpg" .center}
...
## {background-image="libs/Images/01_2-census_apportionment-2020-map01.png" .center background-size='90%'}
...
## Number of countries in the world? {background-image="libs/Images/background-slate_v2.png" .center}
...
## {background-image="libs/Images/01_2-UN_Map_Wikipedia.png" .center background-size='95%'}
...
## Number of current wars? {background-image="libs/Images/background-slate_v2.png" .center}

<br>

```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("libs/Images/01_2-ukraine_fighting.webp")
```
...
## {background-image="libs/Images/01_2-2023_Ongoing_conflicts_around_the_world.png" background-size='90%'}
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/01_2-quote-von-neumann.jpg')
```
...
## This semester you will develop skills: {background-image="libs/Images/background-slate_v2.png" .center}
